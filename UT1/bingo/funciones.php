<?php
    ...
    function mostrarGanadores($ganadores){
        ...
        for($i = 0; $i < count($ganadores);$i++){
            ...
            echo "<br><br><b> el ganador es el jugador número: ".$jugador_ganador."  con el cartón: ".$carton_ganador."</b>";
            echo "<br>";
        }
        ...
        for ($j=0; $j<count($total_jugadores);$j++) {
            ...
            for($k=0; $k<$numero_cartones;$k++){
                ...
                for($i = 0;$i < count($carton);$i++){
                    ...
                    echo "<td align='center' style='width:20px ; background-color:aliceblue'>".$carton[$i]."</td>";
                    if($i == $array_Blancos[0] || $i== $array_Blancos[1]){
                        echo "<td align='center' style='width:20px ; background-color:cornflowerblue'>&nbsp;</td>";
                    }
                }
